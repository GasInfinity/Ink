...
//     where T : BaseEntity, IEntityFactory<T>
// {
...
//         => Location = iden;
//
//     public override ActionResult<ItemStack> UseOnBlock(ItemStack stack, PlayerBaseEntity player, BaseWorld world, BlockPosition location, BlockFace face, float cursorX, float cursorY, float cursorZ, bool insideBlock)
//     {
